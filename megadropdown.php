...
Plugin URL: openintotaldarkness.wordpress.compact(varname)
...
class megadropdown {
	...
	function __construct() {
		...
		// add filter for edit menu walker
		add_filter('wp_edit_nav_menu_walker', array($this, 'md_edit_walker'), 10, 2);
	 ...
	 * md_edit_walker 
	 */
	function md_edit_walker( $walker, $menu_id ){
